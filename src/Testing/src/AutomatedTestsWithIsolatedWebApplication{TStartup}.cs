        ...
        where TStartup : class
{
    ...
    protected XperienceWebApplicationFactory<TStartup> Factory { get; private set; } = default!;
    #endregion
    ...
    protected virtual TimeSpan ArtificialDelay => TimeSpan.FromSeconds( 0 );
    #endregion
    ...
    {
        return new XperienceWebApplicationFactory<TStartup>();
    }
    ...
    {
        await ( Factory?.Host?.StopAsync() ?? Task.CompletedTask );
